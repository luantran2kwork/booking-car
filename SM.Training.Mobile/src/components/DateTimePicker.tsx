...
import { View, TouchableOpacity, Platform, Modal, Text, StyleSheet, TextInput } from "react-native";
        ...
        return (
            <View style={{ flexDirection: "row" }}>
                {this.props.HasTime === true && (
                    <View style={Theme.TimeInput}>
                        ...
                        >
                            ...
                            />
                            <FontAwesome style={{ marginTop: 0, fontSize: 20 }} name="clock" color="#FF9800" />
                        </TouchableOpacity>
                    </View>
                )}
                <View style={Theme.PickerInput}>
                    ...
                    >
                        <TextInput
                            style={{ fontSize: 16, flex: 1, color: "#1B2031", borderColor: "#acacac" }}
                            editable={false}
                            pointerEvents="none"
                            value={this.displayDateValue(this.state.selectedDate)}
                        />
                        <FontAwesome style={{ marginTop: 0, fontSize: 20 }} name="calendar-alt" color="#FF9800" />
                    </TouchableOpacity>
                </View>
                <TouchableOpacity
                ...
                >
                    <FontAwesome
                        style={{ marginLeft: 12, marginRight: 2, fontSize: 20 }}
                        name="times-circle"
                        color="#ff0000"
                    />
                </TouchableOpacity>
                    ...
                    <Modal visible={true} transparent={true} animationType="fade">
                        <View style={{ backgroundColor: "#B3efefef", padding: 25, flex: 1, justifyContent: "center" }}>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "center" }}>
                                <TouchableOpacity activeOpacity={0.8} onPress={() => this.setState({ show: false })}>
                                    <Text style={styles.buttonCancel}>Cancel</Text>
                                </TouchableOpacity>
                                <TouchableOpacity activeOpacity={0.8} onPress={() => this.setDate(this.pickDate)}>
