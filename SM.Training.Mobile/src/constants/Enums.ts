...
enum FeatureID {
  TinhGiaNhanhNhaDatPhoThong = 2101,
  TinhGiaNhanhChungCu = 2102,
  TinhGiaNhanhOto = 2103,
  DanhSachTSKhaoSat = 2104,
  DanhSachBCDGChoDuyet = 2105,
  DanhSachHSDangDinhGia = 2106,
  TinhTrangCongViec = 182007,
  DanhSachHSDangKSo = 182008,
}
...
enum AttachmentRefType {
  MortgageAsset = 1, // Tài sản
  ProcessValuationDocument = 2, // Báo cáo định giá
  CustomerInfo = 3,
  MortgageAssetProductionLineDetail = 15, // Tài sản theo máy
  ProcessValuationDocumentOfMA = 25, // Tài liệu báo cáo định giá của tài sản
