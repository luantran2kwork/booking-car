...
export default class RoleAddNew extends Component<iProps, iState> {
  ...
  async onPressSave() {
    ...
    try {
      ...
      this.props.history.push(
        `./${RouteUrls.Display}/${this.state.role.RoleID}`
      );
    } catch (ex) {
      ErrorHandler.HandlerException(ex);
    }
  ...
  convertToListItem(
    listSpecialPowers: Array<iKeyValuePair<number, string>>
  ): Array<ListItem> {
      ...
      <div className="layout-main box-grid-custom">
        <div className="toolbar">
          ...
          <div className="p-toolbar-group-right">
            ...
            <Link
              className={"sm-button-link margin-left-5"}
              to={`./${RouteUrls.Default}`}
            >
        ...
        <div className="card card-w-title box-grid-custom">
          ...
          <div className="p-grid">
            <div className="p-col-4">
              ...
              <ComboBox
                dataSource={this.state.ListActiveStatus}
                textField="Value"
                valueField="Key"
